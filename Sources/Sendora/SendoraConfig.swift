...
public struct SendoraConfig {
    ...
    /// When `false` (default), analytics events are buffered until `Sendora.consent.grant()`
    ...
    /// Call `Sendora.startAttribution()` after ATT prompt / consent. Default: `true`
...
public struct SendoraIdentifyOptions {
    /// HMAC signature of `userId`, produced by your backend with a server-side secret.
    /// Required when the project is in strict-identity mode — the Sendora backend verifies
